...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
          Hello! I&apos;m Hoang Phi, a passionate web developer and app developer.
          Currently, I&apos;m a software developer with experience in TypeScript, TailwindCSS, and JavaScript. I specialize in frameworks
          ...
          making me well-versed in frontend web development and app development.
          <br className="sm:block hidden" />
          Let&apos;s collaborate to bring your ideas to life!
        </div>
        <div className="w-fit break-words">
          <Link
            href="mailto:hoanganhphidvl05@gmail.com"
            target="_blank"
            rel="noreferrer"
        ...
        <Link
          href="document/CV_Software_engineer.pdf"
          target="_blank"
          rel="noreferrer"
          className="w-fit"
        >
